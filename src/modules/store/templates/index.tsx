...
const StoreTemplate = async ({
  ...
  const preorderProducts = preOrderProducts.filter((p) => p.custom.state === "PREORDER")
  const beingMadeRightNowProducts = preOrderProducts.filter((p) => p.custom.state === "IN_PROGRESS")
