    ...
    <div className="content-container py-20">
      <div className="flex flex-col small:flex-row gap-8 small:gap-12">
        <div className="small:w-1/4 small:sticky small:top-20 small:self-start small:items-start">
          <h1 className="text-[32px] small:text-[48px] font-display font-bold">Privacy Policy</h1>
        </div>
        <div className="small:w-3/4 font-text text-sm space-y-12 pt-[18px]">
          ...
          <section>
            <h2 className="text-[30px] font-display mb-8">What Data We Collect</h2>
            <p className="mb-8">When you use our website or place an order, we may collect the following information:</p>
          ...
          <section>
            <h2 className="text-[30px] font-display mb-8">How We Use Your Data</h2>
          ...
          <section>
            <h2 className="text-[30px] font-display mb-8">Newsletter</h2>
            <p className="mb-8">We use Mailchimp to manage our newsletter.</p>
            <p className="mb-8">By subscribing, you agree that your email address will be stored and processed through Mailchimp for the purpose of sending newsletters.</p>
            <p>You can unsubscribe at any time by clicking the link in the email or contacting us directly.</p>
          </section>

          <section>
            <h2 className="text-[30px] font-display mb-8">Sharing of Data</h2>
            <p className="mb-8">We do not sell or share your personal data with third parties for marketing purposes.</p>
          ...
          <section>
            <h2 className="text-[30px] font-display mb-8">Data Retention</h2>
          ...
          <section>
            <h2 className="text-[30px] font-display mb-8">Your Rights</h2>
            <p className="mb-8">Under GDPR, you have the right to:</p>
            <ul className="list-disc pl-6 space-y-1 mb-8">
          ...
          <section>
            <h2 className="text-[30px] font-display mb-8">Cookies</h2>
          ...
          <section>
            <h2 className="text-[30px] font-display mb-8">Changes to This Policy</h2>
            <p className="mb-8">We may update this Privacy Policy when necessary.</p>
