    ...
    <div className="content-container py-20">
      <div className="flex flex-col small:flex-row gap-8 small:gap-12">
        <div className="small:w-1/4 small:sticky small:top-20 small:self-start small:items-start">
          <h1 className="text-[32px] small:text-[48px] font-display font-bold">FAQ</h1>
        </div>
        <div className="small:w-3/4 font-text text-sm space-y-12 pt-[18px]">
          <section>
            <h2 className="text-[30px] font-display mb-8">How does ordering work?</h2>
            <p className="mb-8">Most of our garments are made through a preorder system.</p>
          ...
          <section>
            <h2 className="text-[30px] font-display mb-8">Why do you work with preorders?</h2>
          ...
          <section>
            <h2 className="text-[30px] font-display mb-8">Where are the garments made?</h2>
            <p className="mb-8">All garments are designed, cut, and sewn in our atelier in Ljubljana.</p>
          ...
          <section>
            <h2 className="text-[30px] font-display mb-8">How long does delivery take?</h2>
            <ul className="list-disc pl-6 space-y-1 mb-8">
          ...
          <section>
            <h2 className="text-[30px] font-display mb-8">Do you ship internationally?</h2>
            <p className="mb-8">Yes, we ship worldwide with Pošta Slovenije.</p>
          ...
          <section>
            <h2 className="text-[30px] font-display mb-8">Can I return my order?</h2>
            <p className="mb-8">Yes, in accordance with EU regulations, you can return standard items within 14 days of receiving your order.</p>
          ...
          <section>
            <h2 className="text-[30px] font-display mb-8">Do you offer exchanges?</h2>
            <p className="mb-8">Yes — exchanges are possible depending on availability.</p>
            <p>Since many items are made to order, we recommend contacting us directly to arrange the best solution.</p>
          </section>

          <section>
            <h2 className="text-[30px] font-display mb-8">Do you repair garments?</h2>
            <p className="mb-8">Yes.</p>
            <p className="mb-8">We offer free repairs on all Volja garments for 10 years from their "date of birth" (embroidered inside each piece).</p>
          ...
          <section>
            <h2 className="text-[30px] font-display mb-8">What is the "date of birth"?</h2>
            <p className="mb-8">Each garment has its own embroidered date of birth.</p>
          ...
          <section>
            <h2 className="text-[30px] font-display mb-8">What payment methods do you accept?</h2>
          ...
          <section>
            <h2 className="text-[30px] font-display mb-8">Can I visit the atelier?</h2>
            <p className="mb-8">Yes — our space is both a workshop and a shop.</p>
